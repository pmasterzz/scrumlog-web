            ...
            <div class="col-lg-12">
                <div class="doorzichtig">
                    ...
                    <div class="row cyclus">
                        ...
                        echo '<a href="?page=addCycle">
                                <button class="col-lg-12 toevoegen">+</button>
                            </a>';
                        foreach ($cycles as $cycle) {
                            echo '<form method="POST" action="php/cycle.php" class="col-lg-3 invullen">'
                                ...
                                . '<h3 title="' . $cycle['Description']  .  '">' . afkorten($cycle['Description'],16) . '</h3>'
                                . 'Start Datum:<br>
                                  <input name="start" type="date" class="form-control" value="' . $cycle['Start_Date'] . '" disabled>'
                                . 'Eind Datum:<br>
                                  <input name="end" type="date" class="form-control" value="' . $cycle['End_Date'] . '" disabled>'
                                . '<div class="row">'
